...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $solarSystem = $this->solarSystemService->getSolarSystemData();

       // dd($solarSystem); // ← Remover cuando se verifique la estructura

        return view('shop::home.index', compact('customizations', 'solarSystem'));
    }
