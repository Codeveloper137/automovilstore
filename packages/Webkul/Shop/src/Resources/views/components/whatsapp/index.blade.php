<div>
    <div id="kv-whatsapp-btn" class="kv-whatsapp-btn fixed right-5 lg:right-14 bottom-10 xl:right-10 lg:bottom-14 z-[50]">
        <a href="https://api.whatsapp.com/send?phone={{ core()->getConfigData('general.general.whatsapp.number') }}&text={{ core()->getConfigData('general.general.whatsapp-mensaje.description') }}"
            ...
            <svg class="h-11 w-11" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
