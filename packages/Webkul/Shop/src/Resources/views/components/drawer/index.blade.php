...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed z-[1000] bg-white max-md:!w-full"
                    :class="{
                        'inset-x-0 top-0': position == 'top',
                        'inset-x-0 bottom-0 max-sm:max-h-full': position == 'bottom',
                        'top-0 bottom-0 ltr:right-0 rtl:left-0': position == 'right',
                        'top-0 bottom-0 ltr:left-0 rtl:right-0': position == 'left'
                    }"
                    :style="'width:' + width"
                    v-show="isOpen"
                >
                    <div class="pointer-events-auto h-full w-full bg-white">
