...
<x-shop::layouts>
    ...
    <div class="kv-contact-page">
        ...
        <div class="kv-contact-grid">
            ...
            {{-- ── COL IZQUIERDA ──────────────────────────────────── --}}
            <div>
                {{-- CORREGIDO: <p> con font-size grande → <div> para evitar anidación de bloques --}}
                <div class="kv-contact-section-title">Información de Contacto</div>
                ...
                <div class="kv-info-item">
                    ...
                    <div>
                        {{-- CORREGIDO: font-size 1.5rem en <p> con otro <p> hermano → usar <div> --}}
                        <div class="kv-info-title">Ubicación</div>
                        <div class="kv-info-text">Barranquilla, Atlántico<br>Colombia 🇨🇴</div>
                    </div>
                </div>
                ...
                <div class="kv-info-item">
                    ...
                    <div>
                        <div class="kv-info-title">Teléfono</div>
                        <div class="kv-info-text"><a href="tel:+573002521314">+57 300 252 1314</a></div>
                    </div>
                </div>
                ...
                <div class="kv-info-item">
                    ...
                    <div>
                        <div class="kv-info-title">Email</div>
                        <div class="kv-info-text"><a href="mailto:info@killavibes.com">info@killavibes.com</a></div>
                    </div>
                </div>
                ...
                <div class="kv-info-item">
                    ...
                    <div>
                        <div class="kv-info-title">Horario de Atención</div>
                        <div class="kv-info-text">24/7 - Siempre disponibles<br>Respuesta garantizada 🧿</div>
                    </div>
                </div>

                {{-- Redes --}}
                <div class="kv-social-section">
                    <div class="kv-contact-section-title">Síguenos</div>
            ...
            <div>
                <div class="kv-form-card">
                    {{-- CORREGIDO: <p> como título de card → <div> (evita que Vue vea bloque dentro de párrafo implícito) --}}
                    <div class="kv-form-card-title">Envíanos un Mensaje</div>
                    ...
                    <x-shop::form :action="route('shop.home.contact_us.send_mail')">
                        ...
                        @if (core()->getConfigData('customer.captcha.credentials.status'))
                            {{-- CORREGIDO: wrapper explícito para contenido dinámico del captcha --}}
                            <div style="margin-bottom:1rem;">
                                <div>{!! Captcha::render() !!}</div>
                            </div>
                        @endif
